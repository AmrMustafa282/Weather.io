...
import CitiesMob from './CitiesMob';
...
const GetWeather = () => {
  ...
  return (
    <div className='bg-primary min-h-screen   max-w-[1900px] mx-auto'>
      <div className='px-4 2xl:px-12 3xl:px-24 mx-auto '>
        <div>
          {/* <Navbar /> */}

          <nav className=' flex justify-between items-end pb-8 pt-4'>
            <div className='hidden lg:block h-[48px]'>
              <img src={logoImg} alt="logo" className='h-full' />
            </div>

            <div className='shadow-lg bg-secondary border-none outline-none  text-white flex justify-center items-center rounded-[58px] border w-[80%] lg:w-[50%] h-[48px]'>
              <span className='pl-4 '>
            ...
            <div className='flex justify-center items-center '>
              ...
              >
                ...
                <p className='font-semibold cursor-pointer hidden lg:block'>Current Location</p>
              </button>
          ...
          {state
            ...
            <>
              <main className='grid grid-cols-1 2xl:grid-cols-4 gap-12 '>
                <div className='col-span-1 bg-primary flex flex-col gap-6'>
                  <Now state={state} />
                  <Forecast state={state} />
                  <Cities state={state} showThisCity={showThisCity} />
                </div>
                <div className='col-span-1 2xl:col-span-3 flex flex-col justify-between gap-6 2xl:gap-0'>
                  <Todays state={state} />
                  <TodayAt state={state} />
                  <CitiesMob state={state} showThisCity={showThisCity} />
                </div>
              </main>
